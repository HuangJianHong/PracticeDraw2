...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    BlurMaskFilter filterNormal = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
    BlurMaskFilter filterInner = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter filterOuter = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter filterSolid = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
